(custom-set-variables
 '(safe-local-variable-values
   '(
     ...
     (elpy-test-pytest-runner-command "tox" "-e" "py27" "--")
     (elpy-test-django-runner-command "tox" "-e" "py27" "--" "--pyargs")
     (elpy-test-django-runner-command "tox" "-e" "py27" "--" "-x" "--pdb" "--durations" "5" "--pyargs")
     (elpy-test-django-runner-command "tox" "-e" "py27" "--" "--durations" "5" "--pyargs")
