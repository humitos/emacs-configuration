  ...
  (setq-default
   ...
   '(
     ...
     (spell-checking :variables
                     ;; May produce freeze when launching an emacs client
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;; disable smartparents gracefully
  ;; https://github.com/syl20bnr/spacemacs/issues/6144#issuecomment-251979196
  ...
  ;; automatically create TAGS in your project
  (setq ctags-update-prompt-create-tags t)
  (setq ctags-update-delay-seconds (* 30 60))
